...
class Controller extends BaseController
{
    ...
    function tekanlogin(Request $req)
    {
        ...
        // merequest data dari blade lalu dicek apakah terdaftar atau tidak jika sudah terdaftar dicek yang sedang login rolenya apa
    }
